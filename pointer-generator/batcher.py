...
class Batch(object):
  ...
  def init_encoder_seq(self, example_list, hps):
    ...
    self.word_id_to_imp = [ex.word_id_to_imp for ex in example_list]
...
class Batcher(object):
  ...
  def __init__(self, data_path, ner_path, vocab, hps, single_pass):
  ...
  def fill_example_queue(self):
    ...
    input_gen = self.text_generator(data.example_generator(self._data_path, self._ner_path, self._single_pass))

    while True:
      try:
        (article, abstract, ner_path) = next(input_gen) # read the next example from file. article and abstract are both strings.
        # print('*******************')
        # print('shoaib article', article)
        # print('shoaib abstract', abstract)
      ...
      example = Example(article, abstract_sentences, ner_path, self._vocab, self._hps) # Process into an Example.
