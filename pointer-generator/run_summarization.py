...
tf.flags.DEFINE_string('ner_path', 'ners_files', 'Folder that contains corresponding ner files')
...
def main(unused_argv):
  ...
  batcher = Batcher(FLAGS.data_path, FLAGS.ner_path, vocab, hps, single_pass=FLAGS.single_pass)
